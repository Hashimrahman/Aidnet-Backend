...
urlpatterns = [
    ...
    path(
        "donation-details/",
        views.DonationDetailedAPIView.as_view(),
        name="donation-detailed-view",
    ),
    path(
        "<int:donation_id>/delete-donation/",
        views.DeleteDonationAPIView.as_view(),
        name="delete-donation",
    ),
    path(
        "<int:donation_id>/update/",
        views.UpdateDonationAPIView.as_view(),
